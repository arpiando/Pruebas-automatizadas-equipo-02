...
{ titulo: 'Post publicado', contenido: 'Contenido de un post publicado para probar la reversión.' },
// Datos para escenario 2 - Previsualizar post [9]
{ titulo: 'Post para previsualizar', contenido: 'Contenido del post para verificar la previsualización.' },
// Datos para escenario 3 - Guardar post como borrador [10]
{ titulo: 'Post borrador', contenido: 'Contenido del post guardado como borrador.' },
...
const datosAleatorios = [
  ...
  // Datos para escenario 1 - Revertir post publicado a borrador [8]
{ titulo: faker.lorem.words(5), contenido: faker.lorem.paragraph() },
// Datos para escenario 2 - Previsualizar post [9]
{ titulo: faker.lorem.words(5), contenido: faker.lorem.paragraph() },
// Datos para escenario 3 - Guardar post como borrador [10]
{ titulo: faker.lorem.words(5), contenido: faker.lorem.paragraph() },
